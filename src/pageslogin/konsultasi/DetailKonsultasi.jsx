            ...
            <div className="relative mt-4">
              ...
              {dropdownOpen && selectedOption === 'online' && (
                <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg">
                  <Link to="/PesanOnline" className="block px-4 py-2 text-gray-800 hover:bg-blue-500">Pesan Online</Link>
                  <Link to="/PesanOffline" className="block px-4 py-2 text-gray-800 hover:bg-blue-500">Pesan Offline</Link>
                </div>
              )}
            </div>
          </div>
          <div className="px-4 md:px-8 py-4 border-t">
            ...
            <div className="mt-4">
              ...
              <div className="mt-4 flex flex-wrap justify-center space-x-2">
                <button className="px-4 py-2 bg-blue-500 text-white rounded-md">6 tahun pengalaman</button>
                <button className="px-4 py-2 bg-gray-300 text-gray-700 rounded-md">Spesialis CBT</button>
                <button className="px-4 py-2 bg-gray-300 text-gray-700 rounded-md">Konseling Pernikahan</button>
                <button className="px-4 py-2 bg-gray-300 text-gray-700 rounded-md">Konseling Keluarga</button>
                <button className="px-4 py-2 bg-gray-300 text-gray-700 rounded-md">Manajemen Stres</button>
              </div>
              <div className="mt-4">
